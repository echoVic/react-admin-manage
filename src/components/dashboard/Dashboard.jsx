...
import b1 from '../../style/imgs/avatar.jpg';
                            ...
                            <Card bordered={false}>
                                ...
                                <ul className="list-group no-border">
                                    <li className="list-group-item">
                                        ...
                                        <div className="clear">
                                            <a href="" className="block">vic</a>
                                            <span className="text-muted">我上线了！</span>
                                        </div>
                                    </li>
                                    <li className="list-group-item">
                                        <a href="" className="pull-left w-40 mr-m">
                                        ...
                                        <div className="clear">
                                            <a href="" className="block">vic</a>
                                            <span className="text-muted">大家好~~</span>
                                        </div>
                                    </li>
                                    <li className="list-group-item">
                                        <a href="" className="pull-left w-40 mr-m">
                                        ...
                                        <div className="clear">
                                            <a href="" className="block">vic</a>
                                            <span className="text-muted">喜迎十九大！！！</span>
                                        </div>
                                    </li>
                                    <li className="list-group-item">
                                        <a href="" className="pull-left w-40 mr-m">
                                        ...
                                        <div className="clear">
                                            <a href="" className="block">vic</a>
                                            <span className="text-muted">加油！加油！</span>
                                        </div>
                                    </li>
                                </ul>
                            </Card>
